...
export default function AdminGracze() {
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(200px,1fr))", gap: 14 }}>
              ...
              <div>
                ...
                <input style={inp} value={form.login} onChange={f("login")} required
                  ...
                  >
                    ...
                    <td style={{ padding: "10px 12px" }}>
                      <div style={{ display: "flex", gap: 6 }}>
                        ...
                        <button onClick={() => { setResetPwId(resetPwId === u.id ? null : u.id); setResetPw(""); setError(""); }}
                          style={btnRowAction}>
                          Hasło
                        </button>
                      </div>
