...
export default function KontoPage() {
  ...
  if (loading) {
    return (
      <div style={pageStyle}>
        <div style={{ color: "#475569", fontSize: 14 }}>Ładowanie...</div>
      </div>
    );
  }
        ...
        <div style={cardStyle}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              <div style={{
                ...
                {(user.player?.imieNazwisko || user.login).charAt(0).toUpperCase()}
              </div>
              <div>
          ...
          {user.player && (
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
              {[
                { label: "Pozycja", value: user.player.pozycja },
                { label: "Numer", value: user.player.numer },
                ...
                <div key={row.label} style={{
                  ...
                  <div style={{ fontSize: 10, color: "#475569", fontWeight: 600, letterSpacing: "0.06em", marginBottom: 3 }}>
          ...
          <form onSubmit={handlePwChange} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div>
              ...
              <input type="password" value={current} onChange={(e) => setCurrent(e.target.value)}
                style={inp} required autoComplete="current-password" placeholder="••••••" />
            </div>
            <div>
