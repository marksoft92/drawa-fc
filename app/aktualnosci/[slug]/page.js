...
import artykuly from '@/content/aktualnosci';
...
export default async function ArticlePage({ params }) {
  ...
  const hasRealPhotos =
    a.photos.length > 1 ||
    (a.photos[0]?.src && !a.photos[0].src.includes('logo.png'));
    ...
    <>
      ...
      <main style={{ paddingTop: 64, background: '#030712', minHeight: '100vh' }}>
        <article style={{ maxWidth: 860, margin: '0 auto', padding: '40px 20px 80px' }}>
            ...
            >
              ...
              <img
                ...
                style={{
                  display: 'block',
                  width: '100%',
                  maxHeight: hasRealPhotos ? 520 : 220,
          ...
          {/* Galeria zdjęć */}
          {a.photos.length > 1 && <ArticleGallery photos={a.photos} />}
