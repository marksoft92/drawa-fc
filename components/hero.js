...
export default function Hero({ tabela, allTimeStats }) {
  const stats = [
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', textAlign: 'center', padding: '0 20px', zIndex: 2 }}>
        <div style={{ fontSize: 'clamp(48px, 10vw, 96px)', fontFamily: "'Bebas Neue', 'Impact', sans-serif", letterSpacing: '0.08em', lineHeight: 1, color: '#fff', textShadow: '0 0 60px rgba(59,130,246,0.5)' }}>
          MKS DRAWA
        </div>

        <div style={{ fontSize: 'clamp(28px, 5vw, 52px)', fontFamily: "'Bebas Neue', 'Impact', sans-serif", letterSpacing: '0.25em', color: '#3b82f6', marginTop: 4, textShadow: '0 0 30px rgba(59,130,246,0.6)' }}>
          DRAWNO
        </div>
