  ...
  <Link href={`/aktualnosci/${artykul.slug}`} style={{ textDecoration: 'none' }}>
    ...
    >
      <div style={{ position: 'relative', aspectRatio: '16/9' }}>
        {artykul.thumbnail ? (
          <Image src={artykul.thumbnail} alt={artykul.title} fill sizes="(max-width: 640px) 90vw, 280px" style={{ objectFit: 'cover' }} />
        ) : (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'row', minHeight: 200 }} className="pinned-inner">
        ...
        <div style={{ position: 'relative', width: '45%', minHeight: 200, flexShrink: 0 }} className="pinned-img">
          ...
          {artykul.thumbnail ? (
            <Image src={artykul.thumbnail} alt={artykul.title} fill sizes="(max-width: 640px) 100vw, 45vw" style={{ objectFit: 'cover' }} />
          ) : (
